...
public class KeithTest {
    ...
    public void importTest() throws IOException {
        File file = new File("F:/Java projects/challenge/java/Keith/src/com/hulk/KeithClass.java");
    ...
    public void packageTest() {
        File f1 = new File("F:/Java projects/challenge/java/Keith/src/code/numbers/NumberFinder.java");
        File f2 = new File("F:/Java projects/challenge/java/Keith/src/code/string/ExtractString.java");
