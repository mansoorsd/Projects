...
public class BusProb {
    ...
    public String output(int capacity, int stops, List<String> listOfInputStrings, String query) {
            ...
            for (String e : i) {
                if (e.contains("+")) {
                    ...
                    if (this.cap <= (0.25 * this.capacity)) {
                        price = (float) ((float) capacity + capacity * 0.6);
        ...
        if(que==2) {
            ...
            outstring = io +" passengers travelled with a fare of " +w +", " +ip +" passengers travelled with a fare of " +t+", "+ia
                    +" passengers travelled with a fare of "+x;
        }
        if (que==3) {
            float g =0;
